...
import shell from '../public/bash_logo.png'

//🥟🦪
function Home(props) {
    return (
	<div className="home">
		<div className='home-jumbobox'>
		<h1 className="title-card">Hi, I'm Michelle | Software Developer <Image src={shell} alt={"Shell"} width={48} placeholder='blur' /></h1>
		<div className='socials'>
			<a href='https://github.com/miiwo'>
			...
			<a href='https://www.linkedin.com/in/michelle-sarah-wong/'>
			...
			<a href='mailto:chellewsa@gmail.com'>
		...
		<p>I'm a lifelong learner with a pay-it-forward mindset&nbsp;&nbsp;｡^‿^｡</p>
		<p>And a lover of puns.</p>
		</div>
